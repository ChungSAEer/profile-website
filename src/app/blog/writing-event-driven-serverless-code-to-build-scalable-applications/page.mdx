...
<BlogTitle slug="writing-event-driven-serverless-code-to-build-scalable-applications" />
...
_You can also connect with me here: [https://chunggtrong.id.vn/](https://chunggtrong.id.vn/)_

<OriginalPost
  text="Read the original post on Dev.to"
  link="https://dev.to/ChungTrong/writing-event-driven-serverless-code-to-build-scalable-applications-2mol"
/>
