...
<BlogTitle slug="my-hackfrost-journey-navigating-development-challenges-with-daytona" />
...
4. **Running the Project**: After pushing our devcontainer to the project repo, we can start the environment easily with:
   ```bash
   daytona create https://github.com/ChungSAEer/flow-forge --devcontainer-path=.devcontainer/devcontainer.json
   ```
...
_For more information about me, checkout my [Portfolio](https://chunggtrong.id.vn/)_

<OriginalPost
  text="Checkout the original post on Dev.to"
  link="https://dev.to/ChungTrong/my-hackfrost-journey-navigating-development-challenges-with-daytona-hdc"
/>
